...
**What I contributed:**  
The feature list was derived from conversations with manufacturing engineers about what they look at manually when routing a part. I then formalized those rules into code.
...
## NOT claiming
- That I deployed to production serving real customer traffic (you deployed to staging/beta; say that)
